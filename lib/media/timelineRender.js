...
export async function renderTimeline(timeline, callbacks) {
  ...
  const needsComposed = hasOverlay || needsReframe || needsClipEffects || needsOverlayLayers || needsMasterAudio || needsFitMode || needsGaps || needsProjectAudio || needsImageClips;
