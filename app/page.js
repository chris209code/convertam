...
import { FileText, Briefcase, Sparkles, Image as ImageIcon, Calculator, Wrench, Upload as UploadIcon, SlidersHorizontal, Download as DownloadIcon } from 'lucide-react';
...
<main className="page">
    ...
    <section className="section" id="tools">
      <div className="shell">
        ...
        <div className="category-grid">
          <article className="category-card bg-blue"><div className="tile-icon" style={{ background: 'var(--accent)' }}><FileText size={27} strokeWidth={2} /></div><h3>PDF Tools</h3><span className="count">12+ Tools</span><p className="card-copy">Convert, merge, split, compress and secure PDFs.</p><a className="card-link" href="/pdf-tools">Explore all →</a></article>
          <article className="category-card bg-green"><div className="tile-icon" style={{ background: 'var(--accent)' }}><Briefcase size={27} strokeWidth={2} /></div><h3>Business Tools</h3><span className="count">8+ Tools</span><p className="card-copy">Invoices, receipts, quotes, ID cards and more.</p><a className="card-link" href="/business">Explore all →</a></article>
          <article className="category-card bg-purple"><div className="tile-icon" style={{ background: 'var(--accent)' }}><Sparkles size={27} strokeWidth={2} /></div><h3>AI Tools</h3><span className="count">10+ Tools</span><p className="card-copy">AI-powered features for smarter everyday work.</p><a className="card-link" href="/ai-tools">Explore all →</a></article>
          <article className="category-card bg-orange"><div className="tile-icon" style={{ background: 'var(--accent)' }}><ImageIcon size={27} strokeWidth={2} /></div><h3>Image Tools</h3><span className="count">9+ Tools</span><p className="card-copy">Convert, edit, resize and optimize images.</p><a className="card-link" href="/image-tools">Explore all →</a></article>
          <article className="category-card bg-cyan"><div className="tile-icon" style={{ background: 'var(--accent)' }}><Calculator size={27} strokeWidth={2} /></div><h3>Calculators</h3><span className="count">25+ Tools</span><p className="card-copy">Finance, health, business and practical calculators.</p><a className="card-link" href="/calculator-hub">Explore all →</a></article>
          <article className="category-card bg-slate"><div className="tile-icon" style={{ background: 'var(--accent)' }}><Wrench size={27} strokeWidth={2} /></div><h3>Utilities</h3><span className="count">20+ Tools</span><p className="card-copy">Everyday tools to make life easier.</p><a className="card-link" href="/utilities-hub">Explore all →</a></article>
        </div>
      </div>
    </section>
    ...
    <section className="section soft">
      <div className="shell">
        ...
        <div className="steps">
          <article className="step-card bg-blue"><span className="step-number">1</span><span className="step-icon"><SlidersHorizontal size={31} strokeWidth={2} /></span><h3>Choose Tool</h3><p className="card-copy">Select the right tool and customize it if needed.</p></article>
          ...
          <article className="step-card bg-green"><span className="step-number">2</span><span className="step-icon"><UploadIcon size={31} strokeWidth={2} /></span><h3>Upload</h3><p className="card-copy">Upload your file securely from your device.</p></article>
          <div className="arrow"><svg width="46" height="24" viewBox="0 0 46 24" fill="none"><path d="M2 12h40m0 0-9-9m9 9-9 9" stroke="currentColor" strokeWidth="2" strokeLinecap="round"/></svg></div>
          <article className="step-card bg-purple"><span className="step-number">3</span><span className="step-icon"><DownloadIcon size={31} strokeWidth={2} /></span><h3>Download</h3><p className="card-copy">Get your result instantly. Fast, easy, secure.</p></article>
        </div>
      </div>
    </section>
