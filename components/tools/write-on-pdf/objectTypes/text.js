...
import { cssFontFamily, getCachedMeasureFont, measureTextWidthPagePx } from '../fontResolver';
...
export function Content({ obj, isEditing, value, onChangeValue, onBlurCommit }) {
  ...
  const textWidthPagePx = measureFont ? measureTextWidthPagePx(measureFont, displayText, obj.fontSize) : 0;
  let marginLeft = 0;
