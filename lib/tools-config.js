export const tools = [
  ...
  { slug: 'redact-pdf', title: 'Redact PDF', category: 'PDF Tools', description: 'Draw boxes over sensitive text or areas and permanently flatten them out — genuinely removed, not just covered.', mode: 'redact-pdf' },
