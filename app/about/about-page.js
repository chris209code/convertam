export const metadata = {
  title: 'About Convertam — Free Document Toolkit, No Login',
  description:
  ...
  return (
    <main className="max-w-3xl mx-auto px-5 md:px-10 py-12">
      ...
      <section className="mb-12">
        <p className="font-mono text-xs text-stamp-amber tracking-wide mb-2">THE FOUNDER</p>
        <div className="rounded-2xl p-6 flex flex-col sm:flex-row items-start gap-6" style={{ background: '#fffefb', border: '1px solid #e2dcc9' }}>
          ...
          />
          <div>
            <h2 className="font-display text-xl font-bold text-ink mb-1">Christopher Okeke</h2>
            <p className="text-xs text-stamp-amber font-semibold mb-3">Founder · Lagos, Nigeria</p>
            <p className="text-ink-soft text-sm leading-relaxed">
              Building simple tools for a simpler you. Convertam was born out of frustration with document tools that require signups, charge fees for basic tasks, or store your files without permission. The goal is simple — give everyone access to powerful document tools, free, private, and without the nonsense.
            </p>
          </div>
        </div>
      </section>
