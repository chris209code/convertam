...
export const SECTIONS = [
  {
    ...
    tools: [
      ...
      { slug: 'recording-studio', title: 'Recording Studio', desc: 'A real multitrack audio editor and mixer — import multiple tracks, edit clips on a timeline, mix with per-track effects, ducking, crossfades and noise reduction, then export as WAV or MP3.', icon: '🎛️' },
