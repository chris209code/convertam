...
export const toolExtras = {
  ...
  'protect-pdf': {
    ...
    questionsPeopleAsk: [
      { q: 'How do I put a password on a PDF for free?', a: 'Protect PDF adds a real password at no cost — upload the file, set a password, and download the locked version.' },
      { q: 'Can I remove a password from a PDF instead?', a: 'Yes — use Unlock PDF if you already know the current password and want to remove it.' },
      { q: 'Is the password stored anywhere?', a: 'No — it\'s used only to encrypt your file during a secure processing step, then the file and password are both deleted automatically.' },
    ],
  },

  'unlock-pdf': {
    supportedFormats: 'PDF only, up to 100MB.',
    bestFor: 'Removing a password from a PDF you already have the password for, so it opens freely or can be edited in another tool.',
    commonUses: [
      'Removing a password from an old statement or contract you no longer need locked',
      'Unlocking a protected file before merging, editing, or converting it elsewhere',
      'Making a password-protected form easier to fill and share with a team',
      'Cleaning up a PDF that was protected out of habit but doesn\'t need to be anymore',
    ],
    proTip: 'This only removes a password you already know — if you\'ve genuinely forgotten the password, no legitimate tool (including this one) can recover or bypass it.',
    questionsPeopleAsk: [
      { q: 'Can this unlock a PDF without knowing the password?', a: 'No — you must enter the current, correct password. This removes a known password; it doesn\'t crack or guess one.' },
      { q: 'Is the password stored anywhere?', a: 'No — it\'s used only to decrypt your file during a secure processing step, then the file and password are both deleted automatically.' },
    ],
  },
  ...
  'remove-pdf-metadata': {
    ...
    commonUses: [
      'Removing your name or company software from a document before sharing it publicly',
      'Cleaning up a PDF before submitting it somewhere that shouldn\'t see its authorship or edit history',
      'Stripping timestamps that reveal when a file was really created or last touched',
      'Auditing a PDF you received to see exactly what hidden properties it carries',
    ],
    proTip: 'Metadata is invisible when you open a PDF normally — check "Document Properties" in most PDF readers to see what\'s actually stored before assuming a file is clean.',
    questionsPeopleAsk: [
      { q: 'Does this remove text or images from the PDF too?', a: 'No — only the hidden file properties (title, author, software, dates) are removed. Every visible page stays exactly the same.' },
      { q: 'Is this the same as redacting sensitive content?', a: 'No — redaction removes visible text or images on the page. This removes hidden file properties instead. Use Redact & Edit PDF if you need to black out visible content.' },
    ],
  },
  ...
  'write-on-pdf': {
    supportedFormats: 'PDF only.',
    bestFor: 'Adding text to any PDF — a real fillable form, a printed form with blank lines, or a scan with no fields or lines at all.',
    commonUses: [
      ...
      'Filling in a real digital form field the moment it\'s detected on upload',
    ],
    proTip: 'Green dashed outlines mark blanks the tool found automatically (like "Date: ______") — click straight into one and it\'s already sized to fit, including shrinking the font if what you type runs long.',
    questionsPeopleAsk: [
      { q: "How do I type on a PDF that isn't a fillable form?", a: 'Write on PDF lets you click anywhere on any PDF — including scans with no real form fields — and type text directly onto that spot. If it does find a real field or a labeled blank, it\'s detected automatically.' },
      { q: 'Is this different from Fill PDF Forms?', a: "Write on PDF also detects and fills real interactive form fields the moment you upload, so it handles that case too — plus everything Fill PDF Forms can't: labeled blanks, printed lines, and scans with no fields at all." },
  ...
  'annotate-pdf': {
    supportedFormats: 'PDF only, up to 100MB.',
    commonUses: [
      'Highlighting key clauses in a contract before a review call',
      'Leaving sticky-note comments for a colleague reviewing the same document',
      'Marking up a draft with freehand notes the way you would on a printout',
      'Flagging sections of a report that need a second look',
    ],
    proTip: 'Sticky notes show both a marker on the page and a readable callout with your comment text — no need to keep a separate list of what each note means.',
    questionsPeopleAsk: [
      { q: 'Does annotating a PDF change or hide the original content?', a: 'No — highlights, drawings, and notes sit visibly on top of the page. Use Redact & Edit PDF instead if you need to permanently remove or black out content.' },
      { q: 'Can other people remove my annotations afterward?', a: 'Once downloaded, annotations are flattened into the page image, so they can\'t be toggled off or edited by the recipient — treat the download as final.' },
    ],
  },
  ...
  'markdown-to-pdf': {
    supportedFormats: 'Markdown (pasted or .md file) → PDF out.',
    bestFor: 'Turning a README, notes, or documentation written in Markdown into a clean, shareable PDF without reformatting it by hand.',
    commonUses: [
      'Converting a project README into a PDF for a report or submission',
      'Turning meeting notes or documentation written in Markdown into a shareable file',
      'Producing a printable PDF from a Markdown-based blog post or article draft',
      'Archiving Markdown-based technical docs as a fixed, portable document',
    ],
    proTip: 'Use "Show Preview" before converting — it renders the exact same formatting the PDF will use, so you can catch a table or code block issue in seconds.',
    questionsPeopleAsk: [
      { q: 'Does this support GitHub-flavored Markdown like tables?', a: 'Yes — headings, lists, bold/italic, links, inline and fenced code blocks, blockquotes, and tables are all supported.' },
      { q: 'Is Markdown to PDF free?', a: 'Yes, completely free with no login required.' },
    ],
  },
  ...
  'pdf-to-jpg': {
    supportedFormats: 'PDF in — JPG or PNG out (one image per page, format is your choice).',
    commonUses: [
      ...
      'Extracting a transparent-friendly PNG from a PDF logo or diagram for reuse elsewhere',
    ],
    proTip: "Choose JPG for ordinary photos/scans — it's smaller. Choose PNG when you need a lossless image, such as pulling a diagram or logo out of a PDF for reuse elsewhere.",
    questionsPeopleAsk: [
      { q: 'How do I convert a PDF page to an image for free?', a: 'Upload your PDF to PDF to JPG/PNG, pick the format, and download — every page converts automatically, free with no login.' },
      { q: 'Can I convert a PDF to JPG or PNG on my phone?', a: 'Yes, this works in any mobile browser — upload your PDF and download the resulting images directly to your phone.' },
      { q: 'Do I need Adobe Acrobat to convert a PDF to an image?', a: 'No, Convertam converts directly in your browser — no Adobe software or account needed.' },
      { q: 'Will my PDF page have a transparent background if I choose PNG?', a: "No — a PDF page renders as a solid image, so the background stays whatever color it was on the page (usually white); PNG enables transparency but doesn't add it retroactively to already-opaque content." },
    ],
  },
  ...
  'images-to-pdf': {
    ...
    proTip: 'Photograph documents against a plain, well-lit background before uploading — a straight, evenly lit shot converts to a page that reads like a proper scan, rather than an obviously photographed one.',
    questionsPeopleAsk: [
      ...
      { q: 'Will converting my images to PDF reduce their quality?', a: 'No, each image is placed into the PDF at its original resolution, with no recompression.' },
    ],
  },
  ...
  'extract-pdf-images': {
    ...
    commonUses: [
      ...
      'Salvaging usable images from an old PDF whose source files were lost',
    ],
    proTip: 'This pulls the images exactly as they were embedded, at their original resolution — if a PDF was built from low-resolution source photos to begin with, extracting them here won\'t recover detail that was never there.',
    questionsPeopleAsk: [
      ...
      { q: 'Why didn\'t it find any images in my PDF?', a: 'If a PDF page looks like a photo but is actually a scanned page (the whole page saved as one image), that counts as a single embedded image and should still be found — but a PDF made entirely of real text and vector graphics has no embedded raster images to extract at all.' },
    ],
  },
  ...
  'heic-to-jpg': {
    ...
    commonUses: [
      ...
      'Making an iPhone photo library shareable with people on non-Apple devices',
    ],
    ...
    questionsPeopleAsk: [
      ...
      { q: 'Can I convert a whole batch of iPhone photos at once?', a: 'Yes — select or drag in multiple HEIC files together and they all convert in one pass, ready to download individually or as a batch.' },
    ],
  },
  ...
  'meme-generator': {
    ...
    commonUses: [
      ...
      'Captioning a pet or family photo for a lighthearted post',
    ],
    ...
    questionsPeopleAsk: [
      ...
      { q: 'What image format does the finished meme download as?', a: 'PNG — it keeps the caption text crisp, which matters more for readability than file size for a meme you\'re about to share.' },
    ],
  },
  ...
  'id-card-generator': {
    ...
    commonUses: [
      ...
      'Producing a batch of volunteer or contractor ID cards for a short-term project',
    ],
    ...
    questionsPeopleAsk: [
      ...
      { q: 'Can I make several ID cards for the same organization without redoing the layout each time?', a: 'Yes — once you\'ve picked an industry and layout preset, generate as many cards as you need from it; only the photo and personal details change per card.' },
    ],
  },
  ...
  'text-case-converter': {
    ...
    commonUses: [
      ...
      'Fixing text that was accidentally typed with Caps Lock stuck on',
    ],
    ...
    questionsPeopleAsk: [
      ...
      { q: 'Does it fix text that\'s stuck in all caps from Caps Lock?', a: 'Yes — paste the accidental all-caps text in and copy the Sentence case or Title Case result, whichever fits what you were originally trying to type.' },
    ],
  },

  'morse-code-translator': {
    supportedFormats: 'No file — type text or Morse code directly, or download the audio as a WAV.',
    commonUses: [
      'Translating a message into Morse code for a Scouts or amateur radio badge',
      'Decoding Morse code from a puzzle, film, or radio exercise',
      'Practicing letter recognition before an amateur radio licensing exam',
      'Generating a Morse audio clip to play back or share',
    ],
    proTip: 'Use Practice Mode\'s "Hear It" direction if you\'re training for an actual radio exam — recognizing the sound is the skill that matters, not just reading the dots and dashes.',
    questionsPeopleAsk: [
      { q: 'How do I convert text to Morse code online for free?', a: 'Type into the Text box on Morse Code Translator and the Morse version appears instantly — no login, no file upload, entirely in your browser.' },
      { q: 'Can I hear Morse code, not just read it?', a: 'Yes — press Play to hear your translation as real Morse code beeps, with adjustable speed (WPM), or download it as a WAV file.' },
      { q: 'What\'s the best way to learn Morse code?', a: 'Start with Learn Mode to hear each letter individually, then move to Practice Mode to test yourself in both directions (sound-to-letter and letter-to-code) before trying the timed Challenge.' },
    ],
  },
  ...
  'summarize-pdf': {
    supportedFormats: 'PDF in — copy text, or download as TXT, Markdown, PDF, or Word.',
    commonUses: [
      'Getting the gist of a long research paper or report before deciding whether to read it fully',
      'Preparing quick revision notes or exam-style questions from a textbook chapter or lecture PDF',
      "Briefing a colleague on a document's key points, risks, or action items without sending the whole file",
      'Getting a chapter-by-chapter breakdown of a long report or book to navigate straight to the part you need',
    ],
    proTip: 'For a document with distinct chapters or sections, try Chapter Summary — it gives you one focused summary per chapter instead of blending everything into a single overview. Once you have a summary, use "Ask this document" to look up a specific detail instead of re-reading the source.',
    questionsPeopleAsk: [
      { q: 'How do I summarize a long PDF quickly?', a: 'Upload your PDF, pick a summary type (Smart, Executive, Bullet, Study Notes, Key Insights, Action Items, or Chapter), and the AI cleans, chunks, and summarizes it — even on long documents.' },
      ...
      { q: 'Can I ask questions about the document after summarizing it?', a: 'Yes — use "Ask this document" below the result. It answers from the summary first, and automatically checks the original text if the summary alone isn\'t detailed enough.' },
    ],
  },
  ...
  'ask-solve-ai': {
    ...
    commonUses: [
      ...
      'Checking your own worked answer against a step-by-step solution before submitting it',
    ],
    ...
    questionsPeopleAsk: [
      ...
      { q: 'Can I ask a question by photographing a textbook page instead of typing it?', a: 'Yes — attach a photo of the problem and Ask & Solve AI reads it directly, which is faster than retyping a long or complex equation by hand.' },
    ],
  },
  ...
  'vat-calculator': {
    ...
    commonUses: [
      ...
      'Comparing pre-tax and post-tax pricing when quoting a job to a client',
    ],
    ...
    questionsPeopleAsk: [
      ...
      { q: 'Can I use this for a VAT rate other than the default?', a: 'Yes — the rate field is fully editable, so you can enter any percentage to match your country\'s actual VAT or sales tax rate.' },
    ],
  },
