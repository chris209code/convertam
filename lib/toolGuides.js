...
Object.assign(toolGuides, {
  ...
  // ---------------------------------------------------------------------
  'pdf-to-jpg': {
    title: 'PDF to JPG/PNG Guide',
    what: 'Turns each page of a PDF into a separate image, in JPG or PNG — your choice.',
    whenToUse: 'Use this when you need individual images from a PDF — dropping pages into a slideshow, a document viewer that only accepts images, a social post, or a transparent-background graphic pulled from a PDF logo or diagram.',
    steps: [
      { title: 'Upload your PDF', body: 'Select the file you want to convert.' },
      { title: 'Choose JPG or PNG', body: 'JPG is smaller for ordinary photos/scans; PNG is lossless and supports transparency.' },
      { title: 'Download your images', body: 'A single-page PDF downloads as one image; a multi-page PDF downloads as a zip with one file per page.' },
    ],
    tips: [
      ...
      'Choose PNG if you specifically need transparent backgrounds or lossless quality, since JPG doesn\'t support transparency.',
      'Password-protected or corrupted PDFs will fail to convert — remove protection first if you have the password.',
      'Need to reduce the resulting image file sizes afterward? Image Compressor works on both JPG and PNG.',
    ],
    mistakes: [
      ...
      'Expecting a transparent background from PNG output — a PDF page renders as a solid image, so the background stays whatever color it was on the page (usually white); PNG enables transparency but doesn\'t add it retroactively to already-opaque content.',
    ],
    quickFaqs: [
      ...
      { q: 'What if my PDF has just one page?', a: 'It downloads directly as a single image rather than a zip.' },
  ...
  'images-to-pdf': {
    ...
    what: 'Combines multiple JPG, PNG, or WebP images into one PDF, in any order you choose, with layout control including standardized A4 pages.',
    whenToUse: 'Use this to turn photographed documents, receipts, screenshots, or diagrams — in any mix of formats — into one shareable PDF, with the option to reorder pages first or standardize them onto A4.',
    steps: [
    ...
    tips: [
      ...
      'Photograph documents against a plain, well-lit background before uploading — a straight, evenly lit shot converts to a page that reads like a proper scan, rather than an obviously photographed one.',
    ],
    mistakes: [
  ...
  'extract-pdf-images': {
    ...
    tips: [
      ...
      'If you actually want a picture of each full page rather than embedded images, PDF to JPG/PNG is the right tool instead.',
    ],
    mistakes: [
    ...
    recommendation: { icon: '📷', prompt: 'No images found, or PDF is a scan?', slug: 'pdf-to-jpg', label: 'Try PDF to JPG/PNG instead' },
    relatedTools: [
...
Object.assign(toolGuides, {
  ...
  'write-on-pdf': {
    ...
    what: 'Adds text that blends naturally with any PDF — scanned forms, bank forms, printed documents, anything. Real interactive form fields are filled in directly when a PDF has them; labeled blanks like "Date: ______" are automatically detected and outlined so you can click straight into them; everywhere else, click anywhere to place text and its style auto-matches the nearest printed text.',
    whenToUse: "Use this for any PDF that needs information added to it — a printed application scanned back in, a form with no interactive fields, a document with a mix of real fields and blank lines, or a note added at a specific spot on any page.",
    steps: [
      { title: 'Upload your PDF', body: 'Every page renders so you can work directly on top of it. Real form fields (if any) become fillable inputs immediately, and detected blanks are outlined in green.' },
      { title: 'Select the Text tool, then click', body: 'Click inside a real field to fill it directly, click inside a green-outlined blank to place text pre-sized to it, or click anywhere else for free-positioned text. A style chip shows the closest font match it found nearby.' },
      { title: 'Insert dates, signatures, checkboxes, or images', body: 'The Quick Insert toolbar adds today\'s date in your chosen format, a drawn or typed signature/initials, a checkbox, a highlight, or an image — placed centered so you can drag it into position.' },
      { title: 'Download your completed PDF', body: 'Text placed in a detected blank automatically shrinks to fit its width if it runs long. Multi-page documents have thumbnails and a page-jump box for quick navigation.' },
    ],
    tips: [
      'Green dashed outlines mark blanks the tool found on its own (a label like "Name:" followed by a line, or a bare underlined run) — click straight into one instead of hunting for the right spot.',
      'If you click near existing printed text with the Text tool, you get a choice: add new text beside it, match its style without touching it, or paint an opaque patch over it and type on top — none of these ever edit the original PDF\'s own text.',
      'Long text placed in a detected blank shrinks its own font size automatically so it never spills past the blank\'s width — you don\'t need to guess a size that fits.',
      "If the PDF has real, interactive form fields, those are detected and filled directly the moment you upload — no need to check a separate tool first.",
    ],
    mistakes: [
      'Expecting "Cover and replace visually" to edit the original PDF\'s text — it paints an opaque patch over it and places new text on top; the original text object underneath is untouched, which is why the label says "visually," not "edit."',
      ...
      'Assuming a signature placed here is a real cryptographic PDF signature — it\'s a visual placement of a drawn or typed signature image, the same as everywhere else in this tool.',
    ],
    quickFaqs: [
      { q: 'Does this handle real fillable PDF forms too?', a: 'Yes — if a PDF has real interactive form fields, they\'re detected and filled directly the moment you upload it, the same as Fill PDF Forms. Everywhere else on the page still works via detected blanks or free-click placement.' },
      { q: 'How does it know where the blanks are?', a: 'It scans the PDF\'s own text layer for a label followed by a run of underscores or dots (like "Date: ______"), or a bare underlined run on its own, and outlines each one in green — click straight into one.' },
      { q: 'Will long text overflow a blank I filled in?', a: 'No — text placed inside a detected blank automatically shrinks to fit that blank\'s width if what you type runs long.' },
      { q: 'Is there a file size limit?', a: 'Yes, 100MB per file.' },
      { q: 'Is this tool free?', a: 'Yes, completely free with no login required.' },
    ],
    recommendation: { icon: '✍️', prompt: 'Need a full signature workflow instead?', slug: 'sign-documents', label: 'Try Sign Documents instead' },
    relatedTools: [
      { slug: 'fill-pdf', icon: '📋' },
      { slug: 'sign-documents', icon: '✍️' },
      { slug: 'redact-pdf', icon: '⬛' },
...
Object.assign(toolGuides, {
  ...
  'contract-summarizer': {
    ...
    what: 'Reads a full contract or agreement — a multi-page PDF, or ordered photos of every printed page — and translates it into a complete plain-language breakdown: parties, key dates, every obligation, payment terms, clauses worth reviewing, and how termination works, each traced back to its page or section so you can verify it in the original.',
    whenToUse: 'Use this before signing or acting on any contract, lease, or agreement when you want a thorough, plain-English understanding of what you\'re actually agreeing to — including how it affects you specifically.',
    steps: [
      { title: 'Upload the contract', body: 'Upload the whole PDF directly, or photos of every printed page in order if you don\'t have a digital copy.' },
      { title: 'Optionally identify your party', body: 'Type your name, company, or role (e.g. "Tenant", "Party B") to get a section highlighting terms that favor you, work against you, or need attention.' },
      { title: 'Summarize', body: 'For PDFs, text is extracted page-by-page in your browser first, so nothing is skipped; for photos, the AI reads every page image directly.' },
      { title: 'Review the full breakdown', body: 'Quick summary, parties, dates & deadlines, obligations by party, money & payment terms, important clauses, termination & exit, and a plain-English bottom line — every legal term translated into everyday language as it\'s explained, each with a page/section reference so you can find it in the original.' },
      { title: 'Copy the summary', body: 'Copy the full breakdown to your clipboard to save or share.' },
    ],
    tips: [
      'Pay close attention to "Important Clauses & Potential Concerns" — that\'s where it flags things like automatic renewal, having to cover someone else\'s costs, or exclusivity, explained in plain English rather than legal terms, and easy to miss on a quick read.',
      'If you tell it which party you are, it adds a "Your Position" section comparing what favors you against what may work against you, term by term.',
      'If your PDF is a scan with no selectable text, upload photos of the pages instead so the AI can read them directly.',
    ...
    mistakes: [
      ...
      'Uploading a scanned PDF with no extractable text and getting an error — upload photos of the pages instead, which the AI reads directly.',
      'Selecting page photos out of order — use the up/down arrows next to each file to fix the order before summarizing.',
      'Skipping "Important Clauses & Potential Concerns" because the summary looks straightforward — that section exists specifically to catch what a quick read might miss.',
    ],
    quickFaqs: [
      ...
      { q: 'Does it just repeat the contract\'s legal language?', a: 'No — every explanation is translated into everyday language. It reads the legal wording, works out what it actually means, and explains that in plain English, with the page or section noted so you can check the original.' },
      { q: 'Can I upload photos instead of a PDF?', a: 'Yes — clear photos of every page work, and is actually required if your PDF is a scan with no selectable text. Select or reorder them in page order.' },
      { q: 'Does it read the whole document, even long ones?', a: 'Yes — every page is analyzed together as one contract, not page by page in isolation.' },
      { q: 'What does entering "which party am I" actually do?', a: 'It adds a "Your Position" section that points out which terms favor you, which may work against you, and how your terms compare to the other party\'s — based strictly on the contract\'s own wording.' },
