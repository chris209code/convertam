          ...
          <article style={{ maxWidth: 760, margin: '0 auto', color: '#334155', lineHeight: 1.75, fontSize: '0.95rem' }}>
            ...
            <section style={{ marginBottom: 36 }}>
              ...
              <ul style={ul}>
                ...
                <li><strong>Split</strong> — click a clip exactly where you want to cut, then click Split (also available right under the timeline). To remove a section from the middle, split at both edges of the part you don&apos;t want, then select that piece and delete it.</li>
                ...
                <li><strong>Transitions</strong> — cut, crossfade/dissolve, fade to black, fade to white, wipe, slide, push, zoom, blur dissolve, or circle/iris reveal between clips, each with a duration you pick from 0.25s to 2s, plus a separate opening/closing fade (to or from black/white) for the very start and end of the video.</li>
