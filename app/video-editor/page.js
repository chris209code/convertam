          ...
          <article style={{ maxWidth: 760, margin: '0 auto', color: '#334155', lineHeight: 1.75, fontSize: '0.95rem' }}>
            ...
            <section style={{ marginBottom: 36 }}>
              ...
              <ul style={ul}>
                ...
                <li><strong>Transitions</strong> — cut, fade, dip to black, dip to white, crossfade, slide, wipe, zoom, or blur between clips, plus a separate opening/closing fade (to or from black/white) for the very start and end of the video.</li>
