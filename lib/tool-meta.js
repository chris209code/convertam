// Tool-specific metadata: steps, tips, related tools
// Used on each tool page for SEO and UX

export const toolMeta = {
  'fill-pdf': {
    steps: ['📤 Upload PDF Form', '⚙️ Fill Fields', '📥 Download Filled PDF'],
    tips: [
    ...
    steps: ['📤 Upload PDF', '⚙️ Convert', '📥 Download DOCX'],
    tips: [
  ...
  'word-to-pdf': {
    steps: ['📤 Upload DOCX', '⚙️ Convert', '📥 Download PDF'],
    tips: [
  ...
  'pdf-to-excel': {
    steps: ['📤 Upload PDF', '⚙️ Convert', '📥 Download XLSX'],
    tips: [
  ...
  'excel-to-pdf': {
    steps: ['📤 Upload XLSX', '⚙️ Convert', '📥 Download PDF'],
    tips: [
  ...
  'pdf-to-powerpoint': {
    steps: ['📤 Upload PDF', '⚙️ Convert', '📥 Download PPTX'],
    tips: [
  ...
  'powerpoint-to-pdf': {
    steps: ['📤 Upload PPTX', '⚙️ Convert', '📥 Download PDF'],
    tips: [
  ...
  'merge-pdf': {
    steps: ['📤 Upload PDFs', '⚙️ Merge', '📥 Download PDF'],
    tips: [
  ...
  'split-pdf': {
    steps: ['📤 Upload PDF', '⚙️ Split', '📥 Download Pages'],
    tips: [
  ...
  'compress-pdf': {
    steps: ['📤 Upload PDF', '⚙️ Compress', '📥 Download Smaller PDF'],
    tips: [
  ...
  'rotate-pdf': {
    steps: ['📤 Upload PDF', '⚙️ Rotate', '📥 Download PDF'],
    tips: [
  ...
  'extract-pdf-pages': {
    steps: ['📤 Upload PDF', '⚙️ Select Pages', '📥 Download PDF'],
    tips: [
  ...
  'jpg-to-pdf': {
    steps: ['📤 Upload JPG', '⚙️ Convert', '📥 Download PDF'],
    tips: [
  ...
  'png-to-pdf': {
    steps: ['📤 Upload PNG', '⚙️ Convert', '📥 Download PDF'],
    tips: [
  ...
  'pdf-to-jpg': {
    steps: ['📤 Upload PDF', '⚙️ Convert', '📥 Download JPGs'],
    tips: [
  ...
  'pdf-to-png': {
    steps: ['📤 Upload PDF', '⚙️ Convert', '📥 Download PNGs'],
    tips: [
  ...
  'sign-pdf': {
    steps: ['📤 Upload Signature Photo', '⚙️ Place on PDF', '📥 Download Signed PDF'],
    tips: [
  ...
  'reorder-pdf': {
    steps: ['📤 Upload PDF', '⚙️ Drag to Reorder', '📥 Download PDF'],
    tips: [
  ...
  'watermark-pdf': {
    steps: ['📤 Upload PDF', '⚙️ Set Watermark', '📥 Download PDF'],
    tips: [
  ...
  'invoice-generator': {
    steps: ['📝 Fill In Details', '⚙️ Generate', '📥 Download PDF'],
    tips: [
  ...
  'smart-converter': {
    steps: ['📤 Upload Document Photo', '⚙️ AI Reads It', '📥 Download Word or Excel'],
    tips: [
  ...
  'receipt-scanner': {
    steps: ['📤 Upload Receipt Photo', '⚙️ AI Extracts Data', '📥 Download Excel'],
    tips: [
