...
// protect-pdf/ocr-pdf/compress-pdf/pdf-to-jpg/the PDF-input office
...
// pdf-to-jpg absorbed the old pdf-to-png route (same component, now a
// single page with a JPG/PNG toggle) — see PdfToImageWorkspace.js.
export const PULL_ONLY_TOOLS = [
  'split-pdf', 'pdf-to-jpg', 'protect-pdf', 'ocr-pdf', 'compress-pdf',
