...
export const WORKFLOWS = [
  {
    ...
    steps: [
      ...
      { toolSlug: 'passport-photo-studio', label: 'Create a Passport Photo', reason: 'Some applications require a photo in a specific size.', optional: true, estimatedMinutes: 3 },
  ...
  },
  {
    ...
    description: 'Create a correctly sized passport, visa, or ID photo with the right background.',
    goalKeywords: ['passport photo', 'passport photograph', 'visa photo', 'id photo', "driver's licence photo", 'photo for application'],
    steps: [
      { toolSlug: 'passport-photo-studio', label: 'Create the Photo', reason: 'Pick a country/document preset for the correct size, head position and background.', estimatedMinutes: 4 },
    ],
  },
  {
    id: 'compare-versions',
