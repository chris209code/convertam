...
const FAQ = [
  ...
  { q: 'I already have a subtitle file — can I just burn that in, without transcription?', a: 'Yes — Burn Subtitles (in the Captions panel, below Auto Captions) is a separate, no-AI path: upload your own .srt or .vtt file, style it (font size, position, text color, outline or a background box), preview it synced to the video, and burn it into your final exported MP4. Nothing is uploaded anywhere for this — it works entirely from the file you give it.' },
          ...
          <article style={{ maxWidth: 760, margin: '0 auto', color: '#334155', lineHeight: 1.75, fontSize: '0.95rem' }}>
            ...
            <section style={{ marginBottom: 36 }}>
              ...
              <ul style={ul}>
                ...
                <li><strong>Burn Subtitles</strong> — already have an .srt or .vtt file? Upload it, style it (font size, position, color, outline/background), preview it synced to playback, and burn it permanently into your exported video — no transcription, no AI, nothing uploaded.</li>
