...
export const toolExtras = {
  ...
  'jpg-to-pdf': {
    ...
    commonUses: [
      ...
      'Building a scanned-document PDF from photos taken on a phone camera',
    ],
    ...
    questionsPeopleAsk: [
      ...
      { q: 'Can I reorder the pages after uploading?', a: 'Yes — before converting, drag the thumbnails into the order you want; the PDF pages follow that same sequence.' },
    ],
  },
  ...
  'png-to-pdf': {
    ...
    commonUses: [
      ...
      'Assembling a step-by-step visual guide from numbered PNG screenshots',
    ],
    proTip: 'Name your files with a leading number (01-step.png, 02-step.png) before uploading — since pages follow upload order, sequential names make it easy to keep a multi-step guide in the right sequence.',
    questionsPeopleAsk: [
      ...
      { q: 'Does a transparent background in my PNG carry over into the PDF?', a: 'No — a PDF page has no transparency layer, so any transparent area in a PNG renders as solid white in the resulting page.' },
    ],
  },
  ...
  'webp-to-jpg': {
    supportedFormats: 'WebP in — JPG or PNG out, batch supported.',
    commonUses: [
      'Converting a WebP image downloaded from a website into a format an older program accepts',
      'Preparing WebP graphics for a print service or design tool that doesn\'t support WebP',
      'Converting to PNG when you need to keep transparency',
      'Batch-converting a folder of WebP images before uploading them elsewhere',
      'Getting a WebP image into a format an older phone or camera app can open',
    ],
    proTip: 'If the WebP file has a transparent background (common for logos and icons), choose PNG — JPG will fill any transparency with solid white.',
    questionsPeopleAsk: [
      { q: 'Why can\'t I open this WebP file in my usual program?', a: 'Not every image program or older tool supports WebP yet — convert to JPG or PNG first and it\'ll open normally everywhere.' },
      { q: 'Can I convert WebP to JPG without an app?', a: 'Yes — this tool works entirely in your browser, no app install or account required.' },
      { q: 'Does converting WebP to JPG lose any quality?', a: 'A small amount, since JPG uses lossy compression — for a graphic with fine detail or text, converting to PNG instead avoids that loss entirely.' },
    ],
  },
