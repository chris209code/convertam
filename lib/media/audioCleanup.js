...
// presence EQ boost, an optional RMS-based loudness normalization pass,
...
export function buildCleanupFilterChain(ctx, inputNode, { intensity = 'medium', reduceHum = true, voiceEnhance = false } = {}) {
