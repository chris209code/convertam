...
Object.assign(toolGuides, {
  ...
  'passport-photo-studio': {
    title: 'Passport Photo Studio Guide',
    what: 'Creates a passport, visa, ID, driver\'s licence, or Green Card photo from any uploaded photo — pick a country/document preset for the correct size, crop and position to a head-height guide, remove and replace the background, and export a single photo or a printable sheet.',
    whenToUse: 'Use this whenever an application asks for a photo in a specific size with a plain background — instead of visiting a photo booth or guessing at crop dimensions yourself.',
    steps: [
      { title: 'Upload a photo', body: 'A clear, front-facing photo works best — even lighting and a fairly plain background make automatic background removal much more reliable.' },
      { title: 'Choose a country/document preset', body: 'Each preset sets the exact output size, an acceptable head-height range, and the required background color.' },
      { title: 'Crop and position', body: 'Zoom and drag to frame the shot, then drag the crown and chin guide lines to match your actual head height — the tool checks this against the preset\'s target range in real time.' },
      { title: 'Adjust background and quality', body: 'Turn on background removal and pick white, off-white, or light grey; fine-tune brightness, contrast, white balance, and sharpness.' },
      { title: 'Export', body: 'Download a single photo (JPG, PNG, or PDF) or a 4-photo or 8-photo print sheet sized for standard photo paper.' },
    ],
    tips: [
      'Automatic face detection only works in some browsers — where it\'s not available, the crown/chin guide lines still give you a clear manual target.',
      'Background removal works best against a plain, evenly lit background (a plain wall is ideal) — it uses the photo\'s corners as a starting point, so a cluttered or textured background may not remove cleanly.',
      'The head-height indicator turns green only when your actual guide-line placement falls inside the preset\'s published range — that\'s a real geometric check on your specific photo, not a generic pass.',
    ],
    mistakes: [
      'Treating a green "head height OK" or "background verified" indicator as a guarantee of official acceptance — these confirm the photo matches the dimensions, head position, and background shown here, which reflect commonly published guidance; always confirm the current requirement with the receiving authority before submitting.',
      'Uploading a photo with a patterned or dark, uneven background and expecting clean automatic removal — the tool says upfront this works best against a plain background, for the same reason official guidance usually asks for one.',
      'Forgetting to re-check the head-height guide after zooming — zoom changes the crop, so the crown/chin lines may need a small adjustment afterward.',
    ],
    quickFaqs: [
      { q: 'Will this guarantee my photo is accepted?', a: "No tool can guarantee acceptance — this matches the dimensions, head position, and background you selected, based on commonly published guidance, but the receiving authority makes the final call." },
      { q: 'Does background removal work on any photo?', a: 'It works best against a plain, evenly lit background. Busy or textured backgrounds may not remove cleanly — you can adjust the sensitivity slider or retake the photo.' },
      { q: 'What\'s a print sheet for?', a: 'Many photo printers and shops charge per print rather than per photo — a 4-photo or 8-photo sheet lets you print several copies of your photo on one piece of standard photo paper.' },
      { q: 'Is this tool free?', a: 'Yes, completely free with no login required, and your photo is never uploaded to a server.' },
    ],
    recommendation: { icon: '🪪', prompt: 'Need this for an ID card too?', slug: 'id-card-generator', label: 'Try ID Card Generator' },
    relatedTools: [
      { slug: 'resize-image', icon: '✂️' },
      { slug: 'id-card-generator', icon: '🪪' },
      { slug: 'document-enhancer', icon: '✨' },
      { slug: 'image-compressor', icon: '🗜️' },
    ],
  ...
  'screenshot-studio': {
    title: 'Screenshot Studio Guide',
    what: 'A screenshot-presentation workspace — wrap a screenshot in a device or browser mockup, turn it into a social post card, build a before/after or product showcase, and annotate it with arrows, callouts, blur, and highlights.',
    whenToUse: 'Use this whenever a plain screenshot needs to look presentable for a landing page, a social post, documentation, or a support ticket.',
    steps: [
      { title: 'Upload your screenshot', body: 'Any PNG or JPG screenshot works.' },
      { title: 'Pick a presentation mode', body: 'Device & browser mockups, social content cards (tweet, LinkedIn, Reddit, and more), or showcase layouts like before/after and product showcase.' },
      { title: 'Style the frame', body: 'Set background color or gradient, padding, corner radius, and shadow.' },
      { title: 'Annotate (optional)', body: 'Add arrows, callouts, numbered steps, highlights, or blur out sensitive information.' },
      { title: 'Export', body: 'Download as PNG, JPG, or WebP.' },
    ],
    tips: [
      'Blur sensitive information (API keys, emails, names) before sharing a screenshot publicly — it\'s a one-click tool in the annotation panel.',
      'The quoted-tweet layout keeps the quoted post visually secondary to the main post, matching how quote-tweets actually read, rather than showing two equal-weight cards.',
      'Numbered-step annotations are ideal for how-to documentation — each click adds the next number in sequence.',
    ],
    mistakes: [
      'Skipping the blur tool on a screenshot that includes personal or sensitive information before sharing it.',
      'Using a device mockup that doesn\'t match your screenshot\'s aspect ratio — pick the frame that fits your content for the cleanest result.',
    ],
    quickFaqs: [
      { q: 'Does this post directly to social media?', a: 'No — it creates an image file you download and post yourself, so it works with every platform without needing account access.' },
      { q: 'Is my screenshot uploaded anywhere?', a: 'No — everything is composed and rendered in your browser.' },
      { q: 'Is this tool free?', a: 'Yes, completely free with no login required.' },
    ],
    recommendation: { icon: '✂️', prompt: 'Need to crop or resize first?', slug: 'resize-image', label: 'Try Image Resizer & Cropper' },
    relatedTools: [
      { slug: 'resize-image', icon: '✂️' },
