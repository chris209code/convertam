...
export const SECTIONS = [
  {
    ...
    tools: [
      ...
      { slug: 'morse-code-translator', title: 'Morse Code Translator', desc: 'Translate text to Morse code and back, with audio playback and Learn/Practice/Challenge modes', icon: '📡', badge: 'free' },
    ],
  },
];
