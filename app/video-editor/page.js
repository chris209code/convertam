...
const FAQ = [
  ...
  { q: 'When I join several videos together, how do I know where I actually am in each original file?', a: 'The transport readout under the preview shows both at once — "Project: 0:42 | Source: 5:18" — so when the playhead sits inside the third clip of a five-video timeline, you can see exactly which moment of THAT clip\'s own original file you\'re looking at, not just how far into the combined timeline you\'ve gotten. Each clip\'s label on the timeline strip also shows its own source range for the same reason, which makes choosing a precise split point on a merged multi-video timeline much easier.' },
          ...
          <article style={{ maxWidth: 760, margin: '0 auto', color: '#334155', lineHeight: 1.75, fontSize: '0.95rem' }}>
            ...
            <section style={{ marginBottom: 36 }}>
              ...
              <ul style={ul}>
                ...
                <li><strong>Split</strong> — click a clip exactly where you want to cut, then click Split (also available right under the timeline). To remove a section from the middle, split at both edges of the part you don&apos;t want, then select that piece and delete it. On a timeline made of several joined videos, a "Project: 0:42 | Source: 5:18" readout under the preview (and on each clip&apos;s own timeline label) always shows exactly where the playhead sits in that clip&apos;s own original file, not just the combined timeline, for a precise split point.</li>
