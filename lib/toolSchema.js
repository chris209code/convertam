...
export const HUB_BY_CATEGORY = {
  ...
  'Career Studio': { name: 'Career Studio', slug: 'career-studio' },
...
export function buildToolSchemas(tool) {
  ...
  const url = `https://www.convertam.app/${path}`;
  ...
  const breadcrumbList = {
    ...
    itemListElement: [
      ...
      ...(hub ? [{ '@type': 'ListItem', position: 2, name: hub.name, item: `https://www.convertam.app/${hub.slug}` }] : []),
