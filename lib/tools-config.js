export const tools = [
  ...
  { slug: 'markdown-to-pdf', title: 'Markdown to PDF', category: 'Document Conversion', description: 'Paste or upload Markdown and convert it to a clean, formatted PDF.', mode: 'markdown-to-pdf' },
  ...
  { slug: 'crop-pdf', title: 'Crop PDF', category: 'PDF Utilities', description: 'Trim the margins or whitespace off every page of a PDF.', mode: 'crop-pdf', workspaceGroup: ['organize'] },
  ...
  { slug: 'unlock-pdf', title: 'Unlock PDF', category: 'PDF Utilities', description: 'Remove a password from a PDF when you already know it.', mode: 'unlock-pdf', workspaceGroup: ['security'] },
  { slug: 'remove-pdf-metadata', title: 'Remove PDF Metadata', category: 'PDF Utilities', description: 'Strip the author, title, software, and timestamp details hidden inside a PDF.', mode: 'remove-pdf-metadata', workspaceGroup: ['security'] },

  // ---------- Image Tools ----------
  // jpg-to-pdf and png-to-pdf were retired (Aug 2026) — images-to-pdf
  // already accepted JPG/PNG/WebP mixed, making them a strict functional
  // subset of it; both old URLs now 301-redirect there (next.config.js).
  // pdf-to-png was retired the same pass — it shared PdfToImageWorkspace.js
  // with pdf-to-jpg, differing only by a fixed output-format prop, so it's
  // now a JPG/PNG toggle on the single pdf-to-jpg page instead.
  { slug: 'pdf-to-jpg', title: 'PDF to JPG/PNG', category: 'Image Tools', description: 'Turn each page of a PDF into a JPG or PNG image.', mode: 'pdf-to-image', imageFormat: 'jpeg', workspaceGroup: ['export'] },
  ...
  { slug: 'pdf-to-text', title: 'PDF to Text', category: 'PDF Tools', description: 'Pull all the readable text out of a PDF into a plain .txt file, page by page.', mode: 'pdf-to-text' },
  ...
  { slug: 'annotate-pdf', title: 'Annotate PDF', category: 'PDF Tools', description: 'Highlight text, draw, and add sticky notes or comments right on the page.', mode: 'annotate-pdf', workspaceGroup: ['edit'] },
  { slug: 'pdf-overlay', title: 'PDF Layout Studio', category: 'PDF Editor', description: 'A professional layout workspace — add text, images, logos, signatures, watermarks, stamps, and intelligent letterheads directly on the page.', mode: 'pdf-overlay', workspaceGroup: ['edit'] },
  ...
  { slug: 'heic-to-jpg', title: 'HEIC to JPG/PNG', category: 'Image Tools', description: 'Convert iPhone HEIC/HEIF photos to JPG or PNG, with batch support.', mode: 'heic-to-jpg' },
  // webp-to-jpg was retired (Aug 2026) — convert-image-format already
  // converts WebP to JPG/PNG, making it a strict functional subset; the
  // old URL now 301-redirects there (next.config.js).
  ...
  // ---------- Smart Converter (AI) ----------
  { slug: 'summarize-pdf', title: 'Summarize PDF', category: 'Smart Converter', description: 'Upload a PDF and get a smart, structured summary — pick from 7 summary types, choose a length, then export or ask follow-up questions about the document.', mode: 'summarize' },
  ...
  { slug: 'morse-code-translator', title: 'Morse Code Translator', category: 'Utilities', description: 'Translate text to Morse code and back, live as you type — with audio playback, a downloadable WAV, and Learn, Practice and Challenge modes.', mode: 'morse-translator' },
