export const tools = [
  ...
  { slug: 'passport-photo-studio', title: 'Passport Photo Studio', category: 'Image Tools', description: 'Create passport, visa, ID and driver\'s licence photos with the correct size, head position and background — pick a country preset, crop, and export.', mode: 'passport-photo-studio' },
