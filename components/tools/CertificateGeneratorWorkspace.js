  ...
  return (
    <div className="cert-app-shell">
      <style>{`
        ...
        .ce-header { position: absolute; top: 7.774%; left: 0; right: 0; display: flex; align-items: center; justify-content: center; gap: 12px; z-index: 2; }
        ...
        .ce-sig-block { position: absolute; top: 76.325%; left: 6%; width: 24%; text-align: center; z-index: 2; }
        ...
        .ce-date-verify { position: absolute; top: 76.325%; right: 6%; display: flex; align-items: flex-end; gap: 3.667%; z-index: 2; }
