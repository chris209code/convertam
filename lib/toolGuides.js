...
Object.assign(toolGuides, {
  ...
  'document-enhancer': {
    ...
    tips: [
      ...
      'If you\'re preparing a signature photo for Sign PDF, Reduce Shadows can help clean up faded or unevenly-lit ink before you upload it there.',
    ],
    mistakes: [
...
Object.assign(toolGuides, {
  ...
  'sign-pdf': {
    ...
    steps: [
      ...
      { title: 'If it doesn\'t succeed', body: 'You\'ll be asked to drag a crop box around just your signature. If the photo\'s lighting or contrast is genuinely poor, you\'ll also see a link to open Document Enhancer first — improve the photo there, then come back and re-upload it.' },
    ...
    quickFaqs: [
      ...
      { q: 'What if my photo has poor lighting or shadows?', a: 'Open Document Enhancer first to clean up the photo, then come back and re-upload it here — Sign PDF will link you there directly if it detects the photo is difficult to work with.' },
