...
export const toolExtras = {
  ...
  'utilities-hub': {
    ...
    commonUses: [
      'Checking an essay or social media post against a word or character limit',
      'Converting a phrase into a camelCase variable name for code',
      'Formatting a heading into proper Title Case for a document',
      'Counting characters for an SEO meta description before publishing',
    ],
    proTip: 'Word Counter\'s sentence and paragraph counts are based on punctuation and line breaks — unusual formatting (no periods, single-line paragraphs) can throw off those two counts even though the word count itself stays accurate.',
    questionsPeopleAsk: [
      ...
      { q: 'Does this count words in languages other than English?', a: 'Word Counter counts based on spaces and word boundaries, so it works reasonably well for most space-separated languages, though results may vary for languages that don\'t use spaces between words.' },
    ],
  },
