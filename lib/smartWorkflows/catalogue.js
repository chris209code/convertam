...
export const WORKFLOWS = [
  ...
  // 'passport-photos' workflow removed while Passport Photo Studio is
  // temporarily de-listed (see lib/tools-config.js) — its only step was
  // that tool, so there was nothing left to sequence.
  {
    id: 'compare-versions',
