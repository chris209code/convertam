...
function bottomSectionLayout(cardY) {
...
function baseElements({ itemsTableY, itemsTableH, headerVariant, headerColor }) {
  ...
  return [
    ...
    { id: 'approvedBy', kind: 'approval', x: APPROVAL_X, y: bottom.approvalY, w: APPROVAL_W, h: bottom.approvalH, visible: true, name: 'Adaeze Nwosu', role: 'Finance Officer' },
    { id: 'signature', kind: 'signature', x: APPROVAL_X, y: bottom.signatureY, w: APPROVAL_W, h: bottom.signatureH, visible: true, mode: 'typed', text: 'Adaeze Nwosu', src: null },
    ...
    { id: 'stamp', kind: 'stamp', x: APPROVAL_X + 40, y: bottom.approvalY + 20, w: 84, h: 84, visible: false, src: null, shape: 'circle', opacity: 85 },
