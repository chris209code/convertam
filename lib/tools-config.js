export const tools = [
  ...
  { slug: 'compare-pdf', title: 'PDF Compare', category: 'PDF Tools', description: 'Compare two versions of a PDF page by page — see added, removed and modified content side by side, overlaid, or in a difference summary you can export.', mode: 'compare-pdf', workspaceGroup: ['organize'] },
  ...
  // Temporarily de-listed from the public site: automatic background
  // removal isn't reliable enough yet for an official-photo workflow (it
  // can misjudge hair/shoulder/clothing edges). The entry stays here
  // rather than being deleted so the route keeps resolving to a "back
  // soon" page instead of 404ing for anyone who already has this URL —
  // see the `disabled` handling in app/[tool]/page.js and
  // ToolPageClient.js. The implementation under lib/passportPhoto/ and
  // components/tools/PassportPhotoStudioWorkspace.js is untouched.
  { slug: 'passport-photo-studio', title: 'Passport Photo Studio', category: 'Image Tools', description: 'Create passport, visa, ID and driver\'s licence photos with the correct size, head position and background — pick a country preset, crop, and export.', mode: 'passport-photo-studio', disabled: true, disabledNote: 'Passport Photo Studio is temporarily unavailable while we improve the accuracy of automatic background removal for official photo requirements. Please check back soon.' },
  { slug: 'screenshot-studio', title: 'Screenshot Studio', category: 'Image Tools', description: 'Turn a plain screenshot into a polished device mockup, social post, or before/after showcase — with annotation tools built in.', mode: 'screenshot-studio' },
  ...
  { slug: 'sign-documents', title: 'Sign Documents', category: 'PDF Editor', description: 'Upload a photo of your handwritten signature and place it anywhere on your document.', mode: 'sign', workspaceGroup: ['edit', 'security'] },
