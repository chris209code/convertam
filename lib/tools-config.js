export const tools = [
  ...
  { slug: 'profit-margin', title: 'Profit Margin Calculator', category: 'Calculators', description: 'Work out profit, margin, and markup from your cost and selling price.', mode: 'profit-margin', basePath: 'calculators' },
