...
export const toolExtras = {
  ...
  'compare-pdf': {
    ...
    questionsPeopleAsk: [
      { q: 'How do I compare two PDF documents for changes online?', a: 'Upload both versions to PDF Compare — added, removed, and modified content is highlighted page by page, with side-by-side, overlay, and difference-summary views, free with no login.' },
      ...
      { q: 'Does PDF Compare work on a contract that already has visible tracked-change markup?', a: "It compares each file's final text content, so visible tracked-change markup already baked into a PDF is treated as ordinary text rather than being specially recognized." },
  ...
  'passport-photo-studio': {
    supportedFormats: 'Photo (JPG/PNG) in — download as JPG, PNG, or PDF; single photo or a 4-photo/8-photo print sheet.',
    commonUses: [
      'Creating a passport photo for a renewal application without visiting a photo booth',
      'Preparing a visa photo to the exact size a specific country requires',
      'Making an ID or driver\'s licence photo with a plain, compliant background',
      'Printing several copies of the same photo on one sheet for a walk-in application',
    ],
    proTip: 'Take the source photo against a plain wall in even daylight — it makes both the head-height guide and the automatic background removal far more reliable than a photo with a busy background or harsh shadows.',
    questionsPeopleAsk: [
      { q: 'What size should a passport photo be?', a: 'It depends on the country — this tool includes presets for Nigeria, the UK, US, Canada, Australia, the Schengen area, India, and South Africa, each set to that document\'s commonly published size and background requirement.' },
      { q: 'Can I remove the background from a passport photo online for free?', a: 'Yes — Passport Photo Studio removes and replaces the background entirely in your browser, free, with no login required.' },
      { q: 'Will this photo definitely be accepted?', a: "It matches the dimensions, head position, and background you selected, based on commonly published guidance — but only the receiving authority can confirm final acceptance, so always check their current requirement." },
    ],
  },

  'screenshot-studio': {
    supportedFormats: 'Screenshot (JPG/PNG) in — download as PNG, JPG, or WebP.',
    commonUses: [
      'Wrapping a product screenshot in a browser or phone mockup for a landing page',
      'Turning a tweet or post screenshot into a clean, shareable card',
      'Building a before/after comparison image',
      'Annotating a screenshot with arrows and callouts for a support ticket or how-to guide',
    ],
    proTip: 'Add padding and a subtle shadow before dropping a screenshot into a slide deck or landing page — it reads as intentional design rather than a raw screen grab.',
    questionsPeopleAsk: [
      { q: 'Can I put my screenshot in a phone or browser frame?', a: 'Yes — Screenshot Studio includes device and browser mockups (Chrome, Safari, Edge, MacBook, Windows laptop, desktop monitor, iPhone, Android, tablet) alongside social post cards and showcase layouts.' },
      { q: 'Can I blur out sensitive information in a screenshot?', a: 'Yes — the annotation tools include a blur tool for hiding sensitive details before sharing.' },
    ],
  },
