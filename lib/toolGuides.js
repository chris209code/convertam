...
Object.assign(toolGuides, {
  ...
  'contract-summarizer': {
    ...
    what: 'Reads a full contract or agreement — a multi-page PDF, or ordered photos of every printed page — and produces a complete plain-language breakdown: parties, key dates, every obligation, payment terms, clauses worth reviewing, plain-English explanations of the legal jargon actually used, and how termination works.',
    ...
    steps: [
      ...
      { title: 'Review the full breakdown', body: 'Quick summary, parties, dates & deadlines, obligations by party, money & payment terms, important clauses, legal jargon explained, termination & exit, and a plain-English bottom line — each with page/section references where possible.' },
      { title: 'Copy the summary', body: 'Copy the full breakdown to your clipboard to save or share.' },
    ],
    tips: [
      'Pay close attention to "Important Clauses & Potential Concerns" — that\'s where the AI flags things like automatic renewal, indemnification, or exclusivity that are easy to miss on a quick read.',
