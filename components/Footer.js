export default function Footer() {
  return (
    <footer className="text-center py-10 px-5 font-mono text-xs text-ink-soft">
      <div className="mb-3">
        <a
          href="https://paystack.shop/pay/convertam-donate"
          target="_blank"
      ...
      the ads, or{' '}
      <a href="https://paystack.shop/pay/convertam-donate" target="_blank" rel="noopener noreferrer" className="underline text-stamp-blue">
        leave a tip
      </a>
      .
    </footer>
