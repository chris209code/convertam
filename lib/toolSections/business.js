...
export const SECTIONS = [
  {
    ...
    icon: '🧾',
    tools: [
      { slug: 'business-document-studio', title: 'Business Document Studio', desc: 'Create invoices, quotations, delivery notes and waybills from one professional workspace', icon: '🗂️' },
