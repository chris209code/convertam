...
Object.assign(toolGuides, {
  ...
  'annotate-pdf': {
    ...
    what: 'Marks up a PDF the way you would on paper — highlight text, draw freehand, and drop sticky-note comments, right on the page.',
    whenToUse: 'Use this to review a document, flag things for someone else, or leave yourself comments — without changing the underlying content the way Redact & Edit PDF or Write on PDF do.',
    steps: [
      { title: 'Upload your PDF', body: 'Each page renders in the editor so you can mark it up directly.' },
      { title: 'Pick a tool and color', body: 'Highlight (drag over an area), Draw (freehand), Sticky Note (click to drop a comment), or Text (click to place a label) — each has its own color options.' },
      { title: 'Click any mark to edit or delete it', body: 'Sticky notes and text reopen their editor; highlights and drawings can be selected and deleted. Undo/redo covers every change.' },
      { title: 'Apply and download', body: 'Every page is rendered into the final file as a flattened image — your annotations become a permanent part of the page.' },
    ],
    tips: [
      'Sticky notes render as a real colored Post-it square on the page, sized and positioned exactly where you drop them, with your comment text wrapped inside.',
      'Use "Clear Page" to wipe everything on the current page and start over without affecting other pages.',
      'Annotations become part of the flattened page image on export — same tradeoff as Redact & Edit PDF, so the exported document loses selectable text everywhere, not just where you marked it up.',
    ],
    mistakes: [
      'Expecting annotations to stay as separate, removable "layers" after download — they\'re flattened into the page image, so undo/redo only works before you apply and download.',
      'Confusing this with Redact & Edit PDF — that tool permanently blacks out or corrects content; this one adds visible marks on top without hiding anything.',
      'Not realizing every downloaded page becomes a flattened image, so the whole document loses selectable, searchable text, not just the annotated areas.',
    ],
    quickFaqs: [
      { q: 'Can I remove an annotation after adding it?', a: 'Yes — click a sticky note or text label to reopen its editor and delete it, or select a highlight or drawing and use "Delete Selected." Undo/redo also works at any point before you apply and download.' },
