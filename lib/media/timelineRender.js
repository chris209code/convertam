...
import { drawCompositionFrame, drawTextOverlays, drawImageOverlays, drawShapeOverlays, drawWatermark, getComposeSize, getFadeOpacity, buildCutoutCanvas } from './compositionLayouts';
...
export async function renderTimeline(timeline, callbacks) {
  ...
  const needsComposed = hasOverlay || needsReframe || needsClipEffects || needsOverlayLayers || needsMasterAudio || needsFitMode || needsGaps || needsProjectAudio || needsImageClips || needsSoundTracks;
