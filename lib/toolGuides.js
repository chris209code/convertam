...
Object.assign(toolGuides, {
  ...
  'document-enhancer': {
    ...
    tips: [
      ...
      'If you arrived here from Sign PDF\'s "try Document Enhancer" link, your photo is already loaded — enhance it, then use the "Continue to Sign PDF" button to go straight back and retry automatic extraction, no re-upload needed.',
    ],
    mistakes: [
...
Object.assign(toolGuides, {
  ...
  'sign-pdf': {
    ...
    what: 'Upload a photo of your handwritten signature and Convertam automatically tries to isolate just the ink from the background, then lets you place it anywhere on a PDF.',
    ...
    quickFaqs: [
      ...
      { q: 'What if my photo has poor lighting or shadows?', a: 'When Sign PDF detects this, the "try Document Enhancer" link carries your photo straight over there — no re-upload needed. Enhance it, then click "Continue to Sign PDF" to come back and automatically retry.' },
...
Object.assign(toolGuides, {
  ...
  'document-translator': {
    ...
    steps: [
      { title: 'Add your text', body: 'Upload a PDF, Word, PowerPoint or text file, paste text directly, or continue with the document already active in your workspace.' },
      { title: 'Pick source and target language', body: 'Source language is detected automatically by default — or set it yourself and use the swap button to flip source and target.' },
      { title: 'Choose a mode', body: 'Fast for a quick, direct translation, or Accurate for slower, more precise and idiomatic results.' },
      { title: 'Translate, then download', body: 'See the translation appear next to your original text, then copy it or download it as .txt, .docx, or .pdf.' },
    ],
    tips: [
    ...
    mistakes: [
      ...
      'Assuming the downloaded .docx or .pdf keeps your original document\'s exact layout — Fast and Accurate modes translate the text itself, not the original page design; Preserve Formatting mode (coming soon) is built specifically for that.',
    ...
    quickFaqs: [
      ...
      { q: "What's the difference between Fast and Accurate?", a: 'Fast returns a direct, natural translation as quickly as possible. Accurate takes a little longer to produce more precise, idiomatic wording — better for formal or sensitive documents.' },
      { q: 'Can I keep the original formatting?', a: 'Fast and Accurate modes translate the text content. Preserve Formatting mode, which reconstructs headings, tables and layout in the translated document, is coming soon.' },
      ...
      { q: 'Is there a limit on how much I can translate?', a: `Yes — up to ${(100000).toLocaleString()} characters per translation (roughly a 50-page document), and a fair-use daily limit per browser, so the tool stays fast and free for everyone.` },
      { q: 'Is this tool free?', a: 'Yes, completely free with no login required, within the daily fair-use limit.' },
    ],
...
Object.assign(toolGuides, {
  ...
  'password-generator': {
    ...
    relatedTools: [
      { slug: 'qr-code-generator', icon: '📱' },
      { slug: 'protect-pdf', icon: '🔒' },
      { slug: 'utilities-hub', icon: '📝' },
      { slug: 'sign-pdf', icon: '✍️' },
    ],
  },

  'utilities-hub': {
    title: 'Word Counter & Text Case Converter Guide',
    what: 'Two everyday text tools in one place — a Word Counter that gives you word, character, sentence, paragraph, and reading-time stats, and a Text Case Converter that instantly converts your text into seven different cases.',
    whenToUse: 'Use the Word Counter when you need to check length against a word or character limit (an essay, a social post, an SEO description). Use the Text Case Converter when you need the same text in a specific format — a variable name, a title, a database key.',
    steps: [
      { title: 'Pick the tool you need', body: 'Switch between Word Counter and Text Case Converter using the two buttons at the top — both live in the same workspace.' },
      { title: 'Word Counter: paste your text', body: 'Instantly see word count, character count (with and without spaces), sentence count, paragraph count, and estimated reading time.' },
      { title: 'Text Case Converter: paste your text', body: 'See it instantly converted into UPPERCASE, lowercase, Title Case, Sentence case, camelCase, snake_case, and kebab-case, all at once.' },
    ...
    tips: [
      ...
      'The reading time estimate in Word Counter is based on an average reading speed, so treat it as a general guide rather than an exact figure for every reader.',
    ],
    mistakes: [
    ...
    quickFaqs: [
      { q: 'Can I use both tools on the same text?', a: 'Yes — switch between Word Counter and Text Case Converter at any time; each keeps its own text independently.' },
