...
export const SECTIONS = [
  {
    ...
    icon: '🖼️',
    tools: [
      { slug: 'pdf-to-jpg', title: 'PDF to JPG/PNG', desc: 'Turn each PDF page into a JPG or PNG image', icon: '🧷', badge: 'free' },
      ...
      { slug: 'heic-to-jpg', title: 'HEIC to JPG/PNG', desc: 'Convert iPhone HEIC photos to JPG or PNG', icon: '📱', badge: 'free' },
