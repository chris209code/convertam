...
export function drawCompositionFrame(ctx, { timeline, mainEl, mainClip, mainOpacity = 1, crossfadeEl, crossfadeClip, crossfadeOpacity = 0, overlayLayers = [], rounded = false, border = false, canvasWidth, canvasHeight }) {
