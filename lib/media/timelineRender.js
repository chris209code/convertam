      ...
      for (const layer of overlayLayers) {
        ...
        if (hit && isImage) {
          ...
          if (hit.clip.id !== layer.lastClipId) {
            await loadClipIntoElement(layer.videoEl, hit.clip, timeline);
            ensureAudioRouted(layer.videoEl, layer.gain, layer.srcRef);
            layer.videoEl.currentTime = hit.sourceTime;
          ...
          layer.gain.gain.value = ((hit.clip.audioMode === 'keep' || mixKeepsOwnAudio) ? 1 : 0) * opacity;
