...
const FAQ = [
  ...
  { q: 'Can I add my own music or sound effects to a video?', a: 'Yes — the Audio tab\'s Sound clips section lets you add as many independent audio clips as you like: background music, sound effects, extra narration. Each upload gets its own clip with a Start time and Length you set numerically, plus its own Volume and Mute, and clips can freely overlap each other. This is separate from the single continuous Audio Track bed (used for pairing a whole replacement audio track with your video) and from a clip\'s own Replace/Mix audio.' },
