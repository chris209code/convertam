export const tools = [
  ...
  { slug: 'pdf-to-png', title: 'PDF to PNG', category: 'Image Tools', description: 'Turn each page of a PDF into a PNG image.', mode: 'pdf-to-image', imageFormat: 'png' },
  ...
  { slug: 'certificate-generator', title: 'Certificate Generator', category: 'Business Tools', description: 'Create certificates of completion, achievement, appreciation and more — 4 templates, print or save as PDF.', mode: 'certificate-generator' },
  ...
  { slug: 'cv-improver', title: 'CV Improver', category: 'Smart Converter', description: 'Paste your CV and AI rewrites it to be more professional, impactful, and ATS-friendly.', mode: 'cv-improver' },
  ...
  // ---------- Utilities ----------
  { slug: 'utilities-hub', title: 'Utilities Hub', category: 'Utilities', description: 'QR Code Generator, Password Generator, Word Counter, Lorem Ipsum — all in one place.', mode: 'utilities-hub' },

  // ---------- Resume / CV ----------
  { slug: 'resume-builder', title: 'Resume Builder', category: 'Business Tools', description: 'Build a professional resume from scratch. Fill in your details and download a clean PDF.', mode: 'resume-builder' },
];
