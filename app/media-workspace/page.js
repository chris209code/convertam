...
const DESCRIPTION = 'Create, edit, transcribe, subtitle, and transform audio & video — transcription, captions, non-destructive video editing, and split-screen or picture-in-picture composition, all in your browser.';
...
const EDITORIAL = {
  intro: [
    "Media Workspace is where audio and video actually get worked on — not just converted from one format to another, but transcribed, captioned, trimmed, and composed into something new. Turn a voice memo into an editable transcript and a captioned video, extract and subtitle the audio track of a video, or cut, reorder, and combine two clips into a split-screen or picture-in-picture composition — all without installing anything.",
  ...
  whoFor: [
    ...
    'Anyone building a side-by-side, top/bottom, or picture-in-picture video from two clips',
  ],
  learnLinks: [],
};
...
const FAQS = [
  {
    q: 'Do I need to install anything to edit video?',
    a: 'No — Video Editor, Video Studio, and Audio Studio all run entirely in your browser using a self-hosted video engine. There\'s nothing to install and no login required.',
  },
  {
    q: 'Is my audio or video uploaded to a server?',
    a: 'Editing, trimming, composing, and caption burn-in all happen locally on your device — the file itself is never uploaded. The one exception is transcription: when you ask for a transcript, the audio is sent for processing and is not stored afterward.',
  },
  {
    q: 'Can I combine two videos into a split-screen or picture-in-picture layout?',
    a: 'Yes — Video Editor supports side-by-side, top/bottom, and picture-in-picture (video-call style) composition from two video clips, or a video with a static image overlay, with a draggable overlay position and real MP4 export.',
  },
];
  ...
  return (
    <>
      ...
      <CategoryLandingClient
        ...
        subtitle="Create, edit, transcribe, subtitle, and transform audio & video."
        editorial={EDITORIAL}
