...
export const SECTIONS = [
  {
    ...
    tools: [
      ...
      { slug: 'markdown-to-pdf', title: 'Markdown to PDF', desc: 'Turn Markdown into a clean, formatted PDF', icon: '📃', badge: 'new' },
      ...
      { slug: 'pdf-to-text', title: 'PDF to Text', desc: 'Pull all the readable text out of a PDF', icon: '📃', badge: 'new' },
    ],
  },
  {
    id: 'editing',
    ...
    tools: [
      ...
      { slug: 'annotate-pdf', title: 'Annotate PDF', desc: 'Highlight, draw, and add sticky notes right on the page', icon: '🖍️', badge: 'new' },
  ...
  },
  {
    ...
    tools: [
      ...
      { slug: 'crop-pdf', title: 'Crop PDF', desc: 'Trim the margins off every page', icon: '✂️', badge: 'new' },
  ...
  },
  {
    ...
    tools: [
      ...
      { slug: 'unlock-pdf', title: 'Unlock PDF', desc: 'Remove a password you already know', icon: '🔓', badge: 'new' },
      { slug: 'remove-pdf-metadata', title: 'Remove PDF Metadata', desc: 'Strip hidden author, software and date details', icon: '🕵️', badge: 'new' },
    ],
  },
  {
    id: 'optimization',
