...
// sourceStart/sourceEnd bound the analysis to a clip's own trimmed range;
// thresholdDb is a standard dBFS silence threshold, minSilenceMs is the
// minimum stretch length worth flagging (shorter gaps are natural speech
// pauses, not "silence to remove").
export async function detectSilence(file, sourceStart, sourceEnd, { thresholdDb = -40, minSilenceMs = 400 } = {}) {
