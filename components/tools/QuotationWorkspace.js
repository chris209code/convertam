...
export default function QuotationWorkspace() {
  ...
  async function handleGenerate() {
    ...
    try {
      ...
      // Footer
      page.drawRectangle({ x: 0, y: 0, width, height: 30, color: blue });
      page.drawText('Generated by Convertam · convertam.app', { x: width / 2 - 100, y: 10, size: 8, font, color: rgb(1,1,1,0.7) });
