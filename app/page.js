    ...
    <section className="section" id="tools">
      <div className="shell">
        ...
        <div className="category-grid">
          <article className="category-card bg-blue"><div className="tile-icon" style={{ background: 'var(--accent)' }}><svg viewBox="0 0 24 24" fill="none"><path d="M7 2h7l4 4v14a1 1 0 0 1-1 1H7a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1Z" stroke="currentColor" strokeWidth="1.6"/><path d="M14 2v4h4" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round"/><rect x="5.2" y="13.5" width="11.5" height="6" rx="1.1" fill="rgba(0,0,0,0.32)"/><text x="11" y="18.1" fontSize="5.6" fontWeight="800" fontFamily="Arial, sans-serif" textAnchor="middle" fill="currentColor">PDF</text></svg></div><h3>PDF Tools</h3><span className="count">12+ Tools</span><p className="card-copy">Convert, merge, split, compress and secure PDFs.</p><a className="card-link" href="/pdf-tools">Explore all →</a></article>
          ...
          <article className="category-card bg-cyan"><div className="tile-icon" style={{ background: 'var(--accent)' }}><svg viewBox="0 0 24 24" fill="none"><rect x="5" y="2.5" width="14" height="19" rx="2" stroke="currentColor" strokeWidth="1.6"/><rect x="7.3" y="4.8" width="9.4" height="3.6" rx="0.8" fill="currentColor" opacity="0.9"/><circle cx="8.4" cy="12" r="1.1" fill="currentColor"/><circle cx="12" cy="12" r="1.1" fill="currentColor"/><circle cx="15.6" cy="12" r="1.1" fill="currentColor"/><circle cx="8.4" cy="15.6" r="1.1" fill="currentColor"/><circle cx="12" cy="15.6" r="1.1" fill="currentColor"/><circle cx="15.6" cy="15.6" r="1.1" fill="currentColor"/><circle cx="8.4" cy="19.2" r="1.1" fill="currentColor"/><circle cx="12" cy="19.2" r="1.1" fill="currentColor"/><circle cx="15.6" cy="19.2" r="1.1" fill="currentColor"/></svg></div><h3>Calculators</h3><span className="count">25+ Tools</span><p className="card-copy">Finance, health, business and practical calculators.</p><a className="card-link" href="/calculator-hub">Explore all →</a></article>
          <article className="category-card bg-slate"><div className="tile-icon" style={{ background: 'var(--accent)' }}><svg viewBox="0 0 24 24" fill="none"><path d="M12 15.2a3.2 3.2 0 1 0 0-6.4 3.2 3.2 0 0 0 0 6.4Z" stroke="currentColor" strokeWidth="2"/><path d="m19.4 15 .4 3-2.7 1.6-2.4-1.8a8 8 0 0 1-2.7 0l-2.4 1.8L6.9 18l.4-3a8.5 8.5 0 0 1-1.4-2.3L3.2 11l.9-3 3-.5a8.5 8.5 0 0 1 1.8-1.6L9.2 3h5.6l.3 2.9a8.5 8.5 0 0 1 1.8 1.6l3 .5.9 3-2.7 1.7a8.5 8.5 0 0 1-1.4 2.3Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round"/></svg></div><h3>Utilities</h3><span className="count">20+ Tools</span><p className="card-copy">Everyday tools to make life easier.</p><a className="card-link" href="/utilities-hub">Explore all →</a></article>
        </div>
      </div>
    </section>
