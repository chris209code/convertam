export const tools = [
  ...
  { slug: 'sign-pdf', title: 'Sign PDF', category: 'PDF Editor', description: 'Upload a photo of your handwritten signature and place it anywhere on a PDF.', mode: 'sign', workspaceGroup: ['edit', 'security'] },
